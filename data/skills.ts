...
export const skills: SkillCategory[] = [
  {
    ...
    description: '// Core languages I use daily',
    items: [
      {
        name: 'Java',
        icon: FaJava,
        ...
        color: '#E32C2E',
        docs: 'https://dev.java/',
        quickStart: 'javac HelloWorld.java',
      },
      {
        name: 'Python',
        icon: FaPython,
        ...
        quickStart: 'python -c "print(\'Hello\')"',
      },
      {
        name: 'Go',
        icon: SiGo,
